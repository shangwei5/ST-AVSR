    ...
    def infer(self):
        ...
        with torch.no_grad():
            ...
            for v in videos:
                ...
                new_list = []
                for idn in range(len(input_frames)):
                ...
                # flops, params = profile(self.net, inputs=(in_tensor, hr_coord, hr_coord, cell))
                # print('GFLOPs: ', flops/1e9/100, 'Params: ', params/1e6)  #1video, 100frame FLops --> /100
                ...
                for i in range(len(input_frames)):
                    ...
                    psnr, ssim = self.get_PSNR_SSIM(output_img[i], gt[i])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/data1/shangwei/dataset/video/REDS/val/val_sharp',
                        help='the path of test data')
    parser.add_argument('--model_path', type=str, default='./refsrrnn_cuf_siren_adists_allstage_only_future_t2_180000_G.pth',
